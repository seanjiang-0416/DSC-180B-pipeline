...
if __name__ == "__main__":
    ...
    data_folder = Path("D:\Study\DSC180\MUSER-master\multi_retriever\data")
    claim_file = data_folder / "liar_claims.txt"
    evidence_file = data_folder / "liar_evidence.txt"
    cliam_evidence_file = data_folder / "liar_claims_evidence.txt"

    f_r_c = open(claim_file,"r", encoding="utf-8")
    f_r_e = open(evidence_file, "w", encoding="utf-8")
    f_r_e_c = open(cliam_evidence_file, "w", encoding="utf-8")
